...
export default function AboutPage() {
  ...
  <section style={{ position: "relative", background: "#06367E", overflow: "hidden" }}>
    <img src="/assets/about-hero.jpg" alt="" aria-hidden="true" style={{ position: "absolute", inset: "0", width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 42%", opacity: ".78" }} />
    <div aria-hidden="true" style={{ position: "absolute", inset: "0", background: "linear-gradient(90deg, #06367E 0%, rgba(6,54,126,.88) 30%, rgba(6,54,126,.4) 62%, rgba(6,54,126,.24) 100%)" }}></div>
    <div aria-hidden="true" style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg, rgba(6,54,126,.42) 0%, rgba(6,54,126,0) 40%, rgba(6,54,126,.4) 100%)" }}></div>
